...
echo "🧹 Antigravity-omgeving opschonen..."
...
echo "📦 Schoonmaken van APT installatie-cache..."
sudo apt-get clean

# 3. PNPM Store opschonen (Zwevende npm bestanden)
...
echo "🔮 Controleren van Vertex AI model warm-up status..."
...
echo "======================================================================"
echo "✅ Onderhoudsbeurt succesvol afgerond: $(date)"
